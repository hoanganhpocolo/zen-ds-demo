...
import { Avatar, Button, Search, Badge, Breadcrumb, BreadcrumbItem, SelectField, SidebarItem } from '@zen/components';
...
const tenantOptions = [
  { value: 'nexus-docs', label: 'Nexus Docs', leading: <img src="/nexus-icon.png" alt="" style={{ width: 24, height: 24, objectFit: 'contain' }} /> },
          ...
          return (
            <div key={item.id}>
              <SidebarItem
                ...
                style={{ marginLeft: item.indent ? 12 : 0 }}
              />
              {hasChildren && isOpen && (
        ...
        <article className="nexus-docs-article">
          <div className="nexus-docs-article-content">
            ...
            <div className="nexus-docs-section" id="objective">
              ...
              <p className="nexus-docs-section-paragraph">
            ...
            <div className="nexus-docs-section" id="flowchart">
              ...
              <div className="nexus-docs-flowchart-legend">
                <div className="nexus-docs-flowchart-item">
                  ...
                  <span className="nexus-docs-flowchart-desc">Represents a specific action or task to be performed</span>
                </div>
                <div className="nexus-docs-flowchart-item">
                  <div className="nexus-docs-flowchart-box nexus-docs-flowchart-box--decision">Decision</div>
                  <span className="nexus-docs-flowchart-desc">Represents a decision point with Yes/No outcomes</span>
                </div>
                <div className="nexus-docs-flowchart-item">
                  <div className="nexus-docs-flowchart-box nexus-docs-flowchart-box--start">Start/End</div>
                  <span className="nexus-docs-flowchart-desc">Represents the beginning or end of a process</span>
                </div>
                <div className="nexus-docs-flowchart-item">
                  <div className="nexus-docs-flowchart-box nexus-docs-flowchart-box--connector">Connector</div>
                  <span className="nexus-docs-flowchart-desc">Represents a connection to another part of the diagram</span>
                </div>
              </div>
            </div>
            ...
            <div className="nexus-docs-section" id="change-types">
              ...
              <div className="nexus-docs-change-types">
                <div className="nexus-docs-change-type">
                  ...
                  <p className="nexus-docs-section-paragraph">Low-risk changes that follow a predefined workflow and can be implemented without extensive approval. These are typically routine maintenance tasks, minor configuration updates, and standard operational procedures.</p>
                </div>
                <div className="nexus-docs-change-type">
                  <h3 className="nexus-docs-change-type-title">Normal Changes</h3>
                  <p className="nexus-docs-section-paragraph">Changes that require assessment, approval, and scheduling. These changes go through the full change management workflow and are reviewed by the Change Advisory Board (CAB) before implementation.</p>
                </div>
                <div className="nexus-docs-change-type">
                  <h3 className="nexus-docs-change-type-title">Emergency Changes</h3>
                  <p className="nexus-docs-section-paragraph">Urgent changes required to resolve critical incidents or security vulnerabilities. Emergency changes require expedited approval and documentation but must still follow post-implementation review processes.</p>
                </div>
              </div>
            </div>
            ...
            <div className="nexus-docs-section" id="roles">
              ...
              <div className="nexus-docs-roles">
                <div className="nexus-docs-role">
                  ...
                  <p className="nexus-docs-section-paragraph">The individual or team initiating the change request. Responsible for providing detailed information about the proposed change, including business justification, risk assessment, and implementation plan.</p>
                </div>
                <div className="nexus-docs-role">
                  <h3 className="nexus-docs-role-title">Change Manager</h3>
                  <p className="nexus-docs-section-paragraph">Oversees the change management process, coordinates activities between stakeholders, maintains documentation, and ensures compliance with established policies and procedures.</p>
                </div>
                <div className="nexus-docs-role">
                  <h3 className="nexus-docs-role-title">Change Advisory Board (CAB)</h3>
                  <p className="nexus-docs-section-paragraph">A cross-functional team that reviews and approves significant changes. The CAB ensures that proposed changes are properly assessed for risk, impact, and alignment with organizational objectives.</p>
                </div>
                <div className="nexus-docs-role">
                  <h3 className="nexus-docs-role-title">System Owner</h3>
                  <p className="nexus-docs-section-paragraph">The individual or team responsible for the affected system. Approves changes to their systems and ensures adequate testing and validation after implementation.</p>
                </div>
              </div>
            </div>
          </div>
